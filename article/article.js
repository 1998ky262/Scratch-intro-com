...
var com2;var com3;
    ...
    main.innerHTML=`<a href="https://scratch.mit.edu/projects/749865423/">ここ</a>に<a id="comkey" style="cursor:pointer" title="クリックでコピー">${key}</a>を先頭につけてコメントしてください。<br>また、<a id="all" style="cursor:pointer" title="クリックでコピー">[all]</a>を使うことですべての記事にコメントできます。なお、返信にはこれらのものは付ける必要はありません。<br>Scratchのアカウントが必要です。反映まで数時間かかります。<div style="opacity:0.1;display:inline;z-index:1;">このコメント機能は<a href="https://yukkku.github.io/">yukkuさんのホームページ</a>を参考にyamaguchi03がオリジナルで作ったものです。</div>`;
